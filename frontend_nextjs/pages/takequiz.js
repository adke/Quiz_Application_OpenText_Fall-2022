          ...
          <div className={styles.answerFormat}>
            <div className={styles.buttonFormat}>
              <Button
                ...
                answerform={answers[0].answerContent}
              >
                {" "}
            ...
            <div className={styles.buttonFormat}>
              <Button
                ...
                className={styles.button18}
                answerform={answers[1].answerContent}
              >
                {" "}
            ...
            <div className={styles.buttonFormat}>
              <Button
                ...
                className={styles.button18}
                answerform={answers[2].answerContent}
              >
                {" "}
            ...
            <div className={styles.buttonFormat}>
              <Button
                ...
                className={styles.button18}
                answerform={answers[3].answerContent}
              >
                {" "}
